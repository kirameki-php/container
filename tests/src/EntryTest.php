...
class EntryTest extends TestCase
{
    ...
    {
        $entry = new EntryLazy(Lifetime::Transient, fn() => new NoType(0));
    ...
    public function test_isResolved_after_getInstance_singleton(): void
    {
        ...
        $entry = new EntryLazy(Lifetime::Singleton, fn() => new NoType(0));
    ...
    {
        $container = $this->builder->build();
        $entry = new EntryLazy(Lifetime::Scoped, fn() => new NoType(0));
        $entry->getInstance($container);
        $this->assertTrue($entry->isResolved());
    }
